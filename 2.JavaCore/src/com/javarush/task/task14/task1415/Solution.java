...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        ...
        for (Apartment anApartment: apartments) {
            if (anApartment instanceof Apt1Room) ((Apt1Room) anApartment).clean1Room();
            if (anApartment instanceof Apt2Room) ((Apt2Room) anApartment).clean2Rooms();
            if (anApartment instanceof Apt3Room) ((Apt3Room) anApartment).clean3Rooms();
        }
    }
